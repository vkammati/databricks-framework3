...
expected_schema_to_tables = {
    euh_schema: {
        'vbrp','vbrk','t006','t006a','mara','marm',
    },
    eh_schema: {
        'md_mm_material_uom_join','md_mm_uom_text_join','fact_sd_sales_header_line_join',
    },
}
...
actual_schema_to_tables = (
    spark
        ...
        .filter(col('table_name').isin(['vbrp','vbrk','t006','t006a','mara','marm','md_mm_material_uom_join','md_mm_uom_text_join','fact_sd_sales_header_line_join']))
