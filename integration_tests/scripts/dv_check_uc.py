...
expected_schema_to_tables = {
    euh_schema: {
        'mseg','glpca','vbrp',"tcurr_bw","tcurv_bw","tcurw_bw","tcurf_bw",'tcurr','tcurv','tcurt','tcurw','tcurn','tcurf','tcurc','tcurr_pattern','date','t006','t006a','mara','marm',
    },
    raw_schema: {
        'datavalidation_control_table',
    },
    eh_schema: {
        'datavalidation_output_table',
    },
}
...
actual_schema_to_tables = (
    spark
        ...
        .filter(col('table_name').isin(['mseg','glpca','vbrp',"tcurr_bw","tcurv_bw","tcurw_bw","tcurf_bw",'tcurr','tcurv','tcurt','tcurw','tcurn','tcurf','tcurc','tcurr_pattern','date','t006','t006a','mara','marm','datavalidation_control_table','datavalidation_output_table']))
