...
expected_schema_to_tables = {
    euh_schema: {
        "tcurr_bw","tcurv_bw","tcurw_bw","tcurf_bw",'tcurr','tcurv','tcurt','tcurw','tcurn','tcurf','tcurc','tcurr_pattern','date','t006','t006a','mara','marm',
    },
    eh_md_schema: {
        "m_time_dimension",
    },
...
actual_schema_to_tables = (
    spark
        ...
        .filter(col('table_name').isin(["tcurr_bw","tcurv_bw","tcurw_bw","tcurf_bw",'tcurr','tcurv','tcurt','tcurw','tcurn','tcurf','tcurc','tcurr_pattern','date','t006','t006a','mara','marm',"m_time_dimension","dim_currency_conversion"]))
