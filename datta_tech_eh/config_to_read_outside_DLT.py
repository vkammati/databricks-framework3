...
print(f"/Workspace/{repos_path.strip('/')}/conf/common/common_conf.json")
...
workflow_name = common_conf.workflow_name
print("workflow_name: ", workflow_name)
dv_workflow_name = common_conf.dv_workflow_name
print("dv_workflow_name: ", dv_workflow_name)
uom_workflow_name = common_conf.uom_workflow_name
print("uom_workflow_name: ", uom_workflow_name)
uom_demo_workflow_name = common_conf.uom_demo_workflow_name
print("uom_demo_workflow_name: ", uom_demo_workflow_name)
