...
# env = "dev"
# repos_path = "/Repos/DATTA-WS-MIGRATION/DATTA-TECH-EH"
...
dlt_table_list = ["DIM_CURRENCY_CONVERSION"]

print("creating EH tables in UC")
create_UC_table(eh_folder_path,uc_catalog_name,uc_eh_schema,"eh", dlt_table_list)


table_list = ["M_TIME_DIMENSION"]

print("creating EH tables in UC")
create_UC_table(eh_md_folder_path,uc_catalog_name,uc_eh_md_schema,"eh", table_list)
