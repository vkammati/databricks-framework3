...
if env=="dev":
  raw_folder_path = raw_folder_path.replace("DS_HANA_CDD", "Ingestion/process_status")
elif env=="tst":
  raw_folder_path = raw_folder_path.replace("DS_HANA_CDD", "Ingestion/process_status")
elif env=="pre":
  raw_folder_path = raw_folder_path.replace("DS_HANA_ZDD", "Ingestion/process_status")
elif env=="prd":
  raw_folder_path = raw_folder_path.replace("DS_HANA_PDD", "Ingestion/process_status")
else:
