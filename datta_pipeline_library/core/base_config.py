...
class CommonConfig:
    ...
    def __init__(
        ...
        self.dv_workflow_name = dv_workflow_name
        self.uom_workflow_name = uom_workflow_name
        self.uom_demo_workflow_name = uom_demo_workflow_name
...
class BaseConfig:
    ...
    def get_dataset_config(self, dataset_name: str, confidentiality: bool = False) -> dict:
        ...
        dir_dict = {
            ...
            "bw_landing_data_path": f"{bw_landing_folder_path}/{dataset_name}_{load_type}",           
